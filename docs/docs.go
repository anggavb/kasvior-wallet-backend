...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        "maxLength": 100,
                        "type": "string",
                        "description": "Search by counterparty, phone, type, payment method, or notes",
                        "name": "q",
                        "in": "query"
                    },
                    {
        ...
        "/users/me/balance": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Get Balance Successfully",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/dto.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.UserBalanceResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.UserExpenseResponse"
                                        }
                                    }
                                }
                            ]
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/dto.UserIncomeResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "dto.TransactionHistoryItemResponse": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
        ...
        "dto.TransactionHistoryMetaResponse": {
            "type": "object",
            "properties": {
                "limit": {
                    "type": "integer"
        ...
        "dto.TransactionHistoryResponse": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.TransactionHistoryItemResponse"
                    }
                },
                "meta": {
                    "$ref": "#/definitions/dto.TransactionHistoryMetaResponse"
                }
            }
        },
        "dto.TransferRequest": {
